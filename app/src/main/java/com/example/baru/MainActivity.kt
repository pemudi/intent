...
import com.example.baru.MoveForResultActivity.Companion.RESULT_CODE
    ...
    override fun onClick(v: View) {
        when (v.id) {
            ...
            R.id.btn_move_with_data -> {
                ...
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_NAME, "Riskha MNJS")
            ...
            R.id.btn_move_with_object -> {
                val Person = Person("Riskha", "riskhamnjs@gmail.com", "Pagak")
